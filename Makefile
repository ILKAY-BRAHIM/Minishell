SRC = executer.c $(addprefix parsing/, main.c get_prompt.c  new_token.c parsing_v3.c  check_token.c ft_strtok.c ft_memmove.c cont_sp.c expanding.c sp_strjoin.c  free_lst.c join_tokens.c check_sp.c\
	get_part.c lexer.c join_tokens2.c free_array.c back_space.c)\
								...
								redirection.c pipex.c exit.c get_here_docs.c execution_utils.c)
